...
| I-H | Self-contained publish + GitHub pre-release (`v0.1.0-alpha.1`, SHA-256 `E4BC287500F8198730A3BC815A0B50AE2A6C58BAA0A0657CBD27278CA6131F4E`) | DONE |
...
| A-05 | `v0.1.0-alpha.3` pre-release + install that exact EXE | IN_PROGRESS |
